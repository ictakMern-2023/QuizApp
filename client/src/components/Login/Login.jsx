...
<Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="md" fullWidth fullScreen>
      <DialogTitle >Select which mode you want to login</DialogTitle>
      <DialogContent>
        <Box display="flex" justifyContent="center" alignItems="center" paddingTop={'100px'}>
          <IconButton onClick={SwitchToModerator}>
            <img src="https://cdn-icons-png.flaticon.com/512/4010/4010411.png" alt="Moderator" width="150" height="150" />
          </IconButton>
